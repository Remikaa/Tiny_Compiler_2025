...
namespace TINY_Compiler
{
    public partial class Form1 : Form
    {
        ...
        void PrintTokens()
        {
            for (int i = 0; i < Compiler.Jason_Scanner.Tokens.Count; i++)
            {
               dataGridView1.Rows.Add(Compiler.Jason_Scanner.Tokens.ElementAt(i).lex, Compiler.Jason_Scanner.Tokens.ElementAt(i).token_type);
            }
        }
